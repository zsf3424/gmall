...
public class AttrGroupController {
    ...
    @GetMapping("{cid}")
    public Resp<PageVo> queryByCidPage(@PathVariable("cid")Long cid,QueryCondition queryCondition){
        PageVo pageVo = this.attrGroupService.queryByCidPage(cid,queryCondition);
