...
//用户登录名称 bingbing@1033266509091410.onaliyun.com
        ...
        String accessId = "LTAI4Fju1HoY5KvokW12SDus"; // 请填写您的AccessKeyId。
        String accessKey = "5FMWDiaK4fQwoX90TsVgOG9T8KFBkq"; // 请填写您的AccessKeySecret。
        String endpoint = "oss-cn-shanghai.aliyuncs.com"; // 请填写您的 endpoint。
        String bucket = "gmall-jpg"; // 请填写您的 bucketname 。
